...
namespace DamageAssessmentSummary
{
    ...
    public partial class DamageAssessmentSummaryResultView : UserControl, IWidget, IDataSourceConsumer, IMapWidgetConsumer
    {
        ...
        public bool Configure(Window owner, IList<DataSource> dataSources)
        {
            ...
            Config.DamageAssessmentSummaryResultViewDialog dialog = new Config.DamageAssessmentSummaryResultViewDialog(dataSources, Caption, DataSourceId, MapWidgetId, Expressions, FieldNameAliasMap, NewFields, UseAliasName, AllSelected, UseExpandable) { Owner = owner };
